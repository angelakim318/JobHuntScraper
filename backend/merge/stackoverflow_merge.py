...
main_csv_path = 'backend/data/stackoverflow_jobs.csv'
main_df = pd.read_csv(main_csv_path)

# Load detailed job information CSV file
detailed_csv_path = 'backend/data/stackoverflow_jobs_detailed.csv'
...
merged_csv_path = 'backend/data/stackoverflow_combined.csv'
