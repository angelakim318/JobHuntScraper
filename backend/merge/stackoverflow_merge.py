...
def merge_stackoverflow_files():
    script_dir = os.path.dirname(os.path.abspath(__file__))
    main_csv_path = os.path.join(script_dir, '..', 'data', 'stackoverflow_jobs.csv')
    detailed_csv_path = os.path.join(script_dir, '..', 'data', 'stackoverflow_jobs_detailed.csv')
    merged_csv_path = os.path.join(script_dir, '..', 'data', 'stackoverflow_combined.csv')
