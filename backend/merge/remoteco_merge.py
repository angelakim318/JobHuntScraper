...
main_csv_path = 'backend/data/remoteco_jobs.csv'
main_df = pd.read_csv(main_csv_path)

# Load detailed job information CSV file
detailed_csv_path = 'backend/data/remoteco_jobs_detailed.csv'
...
merged_csv_path = 'backend/data/remoteco_combined.csv'
